...
public class AutoDebitRegister_Mock_Test {
    ...
    private final CardNumberValidator cardNumberValidator = Mockito.mock(CardNumberValidator.class);
    private final AutoDebitInfoRepository repository = Mockito.mock(AutoDebitInfoRepository.class);
